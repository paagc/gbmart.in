	...
	<div class="col-md-12">
		<div class="box">
					...
					<table class="table table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td>{{ $order->order_logs()->where('status', 'PENDING')->first()->remarks }}</td>
								<td>{{ $order->created_at }}</td>
							</tr>
							@empty
							<tr>
								<td colspan="8" class="text-center">No Pending Orders Available</td>
							</tr>
							@endforelse
						</tbody>
					</table>
			...
			<div class="box-footer clearfix">
				{{ $pending_orders->appends(app('request')->all())->render() }}
			</div>
		</div>
	</div>
</div>
