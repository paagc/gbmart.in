					...
					<table class="table table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center"><a class="btn btn-xs show-detail" order-id="{{ $order->id }}"><i class="fa fa-arrow-down"></i></a></td>
							</tr>
										...
										<div class="box-footer">
											<div class="input-group">
												<div class="input-group-btn">
													...
													<button type="button" class="btn btn-success pull-right change-status" order-id="{{ $order->id }}" status="approved">Mark as Approved</button>
													<button type="button" class="btn btn-danger pull-right change-status" order-id="{{ $order->id }}" status="rejected">Mark as Rejected</button>
													@elseif($order->status == 'APPROVED')
													<button type="button" class="btn btn-success pull-right change-status" order-id="{{ $order->id }}" status="packed">Mark as Packed</button>
