            ...
            <div class="header-top-inner">
                <div class="cnt-account">
                    <ul class="list-unstyled">
                        <li><a href="tel:+918055623322" style="text-decoration: none;"><i class="fa fa-phone"></i>(+91)
                                8055-623-322</a></li>
                        ...
                        @if (Auth::check() && Auth::user() && Auth::user()->type == 'customer')
                            ...
                            <li><a href="/store/my-account/orders"><i class="icon fa fa-thumb-tack"></i>Track Your Order</a>
                            </li>
                        ...
                        <a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
                            <div class="items-cart-inner">
                                ...
                                <div class="total-price-basket">
                                    <span class="lbl">cart -</span> <span class="total-price"><span
                                                class="fa fa-inr"></span>{{ Cart::subtotal() }}</span>
                                </div>
                            </div>
                        </a>
                            ...
                            <li>
                                <div class="cart-item product-summary">
                                    ...
                                    @foreach($cart_items as $item)
                                        <div class="row">
                                            <div class="col-xs-4">
                                                <div class="image"><img
                                                            src="{{ $item['seller_product']->product->product_images[0]->url }}"
                                                            alt=""></div>
                                            </div>
                                            <div class="col-xs-7">
                                                <h3 class="name"><span
                                                            style="font-weight: 600;">{{ substr($item['seller_product']->product->name, 0, 10) . "..." }}</span>
                                                    x <span style="font-weight: 600;">{{ $item['quantity'] }}</span>
                                                </h3>
                                                @foreach($item['options']->all() as $key => $attr)
                                                    <span style="font-size: 11px; "><span
                                                                style="text-decoration: capitalize;">{{ $key }}</span>: {{ $attr }}</span>
                                                @endforeach
                                                <div class="price"><span
                                                            class="fa fa-inr"></span>{{ $item['seller_product']->seller_price }}
                                                </div>
                                            </div>
                                            <div class="col-xs-1 action"><a
                                                        href="/store/cart/remove/{{ $item['rowId'] }}"><i
                                ...
                                <div class="clearfix cart-total">
                                    <div class="pull-right"><span class="text">Sub Total :</span><span
                                                class='price'><span class="fa fa-inr"></span>{{ $subtotal }}</span>
                                    </div>
                                    <div class="clearfix"></div>
                        ...
                        <div class="nav-outer">
                            <ul class="nav navbar-nav">
                                @foreach(\App\Category::with(['sub_categories' => function($query) { $query->where('status', 'ACTIVE')->orderBy('id', 'asc'); }])->whereHas('sub_categories', function ($query) { $query->where('status', 'ACTIVE'); })->where('status', 'ACTIVE')->orderBy('id', 'asc')->get() as $index => $category)
                                    ...
                                    @if($index < 10)
                                        <li class="dropdown"><a href="#" class="dropdown-toggle text-uppercase"
                                                                data-hover="dropdown"
                                                                data-toggle="dropdown">{{ $category->display_name }}</a>
                    ...
                    <div class="module-body">
                        <ul class="toggle-footer" style="">
                            ...
                            <li class="media">
                                ...
                                <div class="media-body">
                                    <p><a href="tel:+918055623322" style="text-decoration: none;">(+91) 8055-623-322</a>
                                    </p>
                                </div>
                            </li>
                            <li class="media">
    ...
    <div class="copyright-bar">
        <div class="container">
            <div class="col-xs-12 col-sm-6 no-padding social">
                        ...
                        Powered by :<a href="http://paagcdigital.com/"
                                       target="blank"><span>Paagc Digital Pvt.Ltd.</span> </span></a>
            </div>
