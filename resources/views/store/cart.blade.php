                                    ...
                                    <tr>
                                        ...
                                        <td class="cart-product-quantity">
                                            <div class="cart-quantity">
                                                ...
                                                <input style="width: 60px" id="qtyInput{{ $index + 1 }}"
                                                       type="number" min="1"
                                                       value="{{$item['quantity']}}">
                                                <button type="button"
                                        ...
                                        <td class="cart-product-grand-total"><span
                                                    class="cart-grand-total-price">RS. {{ number_format($item['seller_product']->seller_price * $item['quantity'] + $item['seller_product']->delivery_charge, 2, '.', ',') }}</span>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
                            ...
                            <tr>
                                <th>
                                    ...
                                    <div class="cart-grand-total">
                                        Grand Total<span
                                                class="inner-left-md fa-inr">{{ number_format($total, 2, '.', ',') }}</span>
                                    </div>
                                </th>
                            </tr>
                            </thead>
                                    ...
                                    <td>
                                        <div class="cart-checkout-btn pull-right">
                                            <a href="/store/checkout">
                                                <button class="btn btn-primary checkout-btn">PROCCED TO CHECKOUT
                                                </button>
                                            </a>
                                        </div>
                                    </td>
