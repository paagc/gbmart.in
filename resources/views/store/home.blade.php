                        ...
                        <nav class="yamm megamenu-horizontal">
                            <ul class="nav">
                                ...
                                @foreach($categories as $category)
                                    <li class="dropdown menu-item"><a href="#" class="dropdown-toggle text-uppercase"
                                                                      data-toggle="dropdown"><i
                                                    class="icon fa {{ $category->fa_icon }}"
                                                    aria-hidden="true"></i>{{ $category->display_name }}</a>
                                                            ...
                                                            <ul>
                                                                @foreach($category->sub_categories as $index => $sub_category)
                                                                    @if($index >= ($i * 3) && $index < (($i + 1) * 3))
                                                                        <li>
                                                                            <a href="/store/{{ $category->name }}/{{ $sub_category->name }}">{{ $sub_category->display_name }}</a>
                                                                        </li>
                                                                    @endif
                                                                @endforeach
                                                            </ul>
                                    ...
                                    <div class="item">
                                        <div class="products">
                                            <div class="hot-deal-wrapper">
                                                <div class="image custom-product-image"><img
                                                            src="{{ $seller_product->product->product_images[0]->url }}"
                                                            alt=""></div>
                                            </div>
                                            ...
                                            <div class="product-info text-left m-t-20">
                                                <h3 class="name"><a
                                                            href="/store/{{ $seller_product->product->category->name }}/{{ $seller_product->product->sub_category->name }}/{{ $seller_product->product->name }}-{{ $seller_product->id }}">{{ (strlen($seller_product->product->display_name) > 20 ? substr($seller_product->product->display_name, 0, 15) . "..." : $seller_product->product->display_name) }}</a>
                                                </h3>
                                                <div class="rating rateit-small"></div>
                                                <div class="product-price"><span class="price"><span
                                            ...
                                            <div class="cart clearfix animate-effect">
                                                <div class="action">
                                                    <div class="add-cart-button btn-group">
                                                        <button seller-product-id="{{ $seller_product->id }}"
                                                                class="btn btn-primary icon seller-product"
                                                                data-toggle="dropdown" type="button"><i
                                                                    class="fa fa-shopping-cart"></i></button>
                                                        <button seller-product-id="{{ $seller_product->id }}"
                                                                class="btn btn-primary cart-btn buy-now" type="button">
                                                            Buy now
                                                        </button>
                                                    </div>
                                                </div>
                                                                ...
                                                                <div class="product-image">
                                                                    <div class="image custom-product-image">
                                                                        <a href="/store/{{ $seller_product->product->category->name }}/{{ $seller_product->product->sub_category->name }}/{{ $seller_product->product->name }}-{{ $seller_product->id }}">
                                                                            <img src="{{ $seller_product->product->product_images[0]->url }}"
                                                                                 alt="">
                                                                        </a>
                                                                    </div>
                                                                </div>
                            ...
                            <div class="tab-content outer-top-xs">
                                <div class="tab-pane in active" id="all">
                                    <div class="product-slider">
                                        <div class="owl-carousel home-owl-carousel custom-carousel owl-theme custom-product-boxes"
                                             data-item="4">
                                            ...
                                            @foreach($new_products as $seller_product)
                                                <div class="item item-carousel custom-product-box">
                                                    <div class="products">
                                                        <div class="product">
                                                            <div class="product-image">
                                                                <div class="image custom-product-image"><a
                                                                            href="/store/{{ $seller_product->product->category->name }}/{{ $seller_product->product->sub_category->name }}/{{ $seller_product->product->name }}-{{ $seller_product->id }}">
                                                                        <img src="{{ $seller_product->product->product_images[0]->url }}"
                                                                             alt=""></a>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="action">
                                                                    <ul class="list-unstyled">
                                                                        <li class="add-cart-button btn-group">
                                                                            <a href="#"
                                                                               seller-product-id="{{ $seller_product->id }}"
                                                                               data-toggle="tooltip"
                                                                               class="btn btn-primary icon seller-product"
                                                                            ...
                                                                            <a href="#"
                                                                               seller-product-id="{{ $seller_product->id }}"
                                                                               class="btn btn-primary cart-btn seller-product"
                                                                               type="button">Add to cart</a>
                                                                        </li>
                                                                        <li product-id="{{ $seller_product->product->id }}"
                                                                            class="lnk wishlist add-wishlist"><a
                                                                                    data-toggle="tooltip"
                                ...
                                @foreach($offers as $offer)
                                    <div class="col-md-7 col-sm-7">
                                        <div class="wide-banner cnt-strip">
                                            <div class="image"><img class="img-responsive" src="{{ $offer->image_url }}"
                                                                    alt=""></div>
                                        </div>
                                    </div>
                                @endforeach
                                                                ...
                                                                <div class="action">
                                                                    <ul class="list-unstyled">
                                                                        ...
                                                                        <li class="lnk wishlist add">
                                                                            <a product-id="{{ $seller_product->product->id }}"
                                                                               data-toggle="tooltip"
                                                                               class="add-to-cart add-wishlist" href="#"
                                                                               title="Wishlist"> <i
                                                                                        class="icon fa fa-heart"></i>
                                                                            </a>
                                                                        </li>
                                                                        <li class="lnk">
                                                                            <a seller-product-id="{{ $seller_product->id }}"
                                                                               data-toggle="tooltip"
                                                                               class="add-to-cart buy-now" href="#"
                                                                               title="Buy now"> <i
                                                                                        class="fa fa-shopping-bag"
                                                                                        aria-hidden="true"></i> </a>
                                                                        </li>
...
@section('footer')
    ...
    <div id="htmlData-modal" class="modal fade" role="dialog">
