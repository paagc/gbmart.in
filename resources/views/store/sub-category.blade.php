                                ...
                                <div class="sidebar-widget-body">
                                    <ul>
                                        @foreach($brands as $brand)
                                            <div class="checkbox"><label> <input type="checkbox" class="check-brand"
                                                                                 data-value="{{ $brand }}"
                                                                                 @if (in_array($brand, $selected_brands)) checked @endif> {{ $brand }}
                                                </label></div>
                                        @endforeach
                                    </ul>
                                </div>
                                ...
                                <div class="sidebar-widget-body m-t-10">
									...
									<span class="min-max">
										<span class="pull-left"><span
                                                    class="fa fa-inr"></span>{{ $price_range_min }}</span>
										<span class="pull-right"><span
                                                    class="fa fa-inr"></span>{{ $price_range_max }}</span>
									</span>
                                                                ...
                                                                <div class="action">
                                                                    <ul class="list-unstyled">
                                                                        ...
                                                                        <li class="lnk wishlist">
                                                                            <a href="{{url("store/cart/add/{$seller_product->id}")}}"
                                                                               class="add-to-cart" title="Wishlist">
                                ...
                                <div class="text-right">
                                    <div class="pagination-container">
                                        <ul class="list-inline list-unstyled">
                                            @if ($page > 1)
                                                <li class="prev"><a
                                                            href="{{ $url . $url_query_append . "page=" . ($page - 1) }}"><i
                                                                class="fa fa-angle-left"></i></a></li>
                                            @endif

                                            @for ($i = 1; $i <= $page_count; $i++)
                                                <li @if ($page == $i) class="active" @endif><a
                                                            href="{{ $url . $url_query_append . "page=" . $i }}">{{ $i }}</a>
                                                </li>
                                            @endfor
